...
public static class TutorialContent
{
    ...
    static readonly Dictionary<string, TutorialEntry> Entries = new Dictionary<string, TutorialEntry>
    {
        ...
        [VeteranCreated] = new TutorialEntry(VeteranCreated, SectionProgress, "Создан ветеран",
            "Пройдя хотя бы один этаж целиком, героиня попадает в колоду ветеранов вместе со своими навыками и снаряжением.\n\n" +
            "Её оценка зависит от того, как глубоко она зашла. Чем выше оценка, тем больше навыков ветеран сможет передать ученице."),
        ...
        [Veterans] = new TutorialEntry(Veterans, SectionProgress, "Колода ветеранов",
            ...
            "Чем выше оценка ветерана, тем больше навыков он передаёт. Уникальный пассивный навык передаётся всегда."),
