...
Актуальный перечень всех подключённых сцен и их триггеров находится в
`Docs/Narrative/SceneCatalog.md`. В частности, варианты отношений являются отдельными сценами:

- `jennifer_intro_tavern` — «Первая встреча»;
- `jennifer_camp_low` / `jennifer_camp_high` — обычный привал;
- `jennifer_hot_springs_low` / `jennifer_hot_springs_high` — горячие источники.

Триггеры вступительных сцен, обычного привала и личной комнаты подключены в игровом цикле.
